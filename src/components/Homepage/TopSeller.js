...
const TopSeller = () => {
  return (
    <Grid className={' mb-14 xl:mb-64 grid-cols-5 lg:grid-cols-12'}>
      <div className="col-span-2 xl:col-span-4 flex flex-col items-center justify-center">
      ...
      <div className="col-span-3 xl:col-span-8 xl:col-end-13 flex items-center">
        <p className="text-white text-base sm:text-xl xl:text-[40px] leading-normal font-prettywise font-semibold tracking-wider">
          We are{' '}
