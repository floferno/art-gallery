    ...
    <>
      <div className="bg-brand-senary w-full ">
        <Container className={'flex flex-col'}>
          <div className="border text-white py-[63px] px-[34px] w-auto border-brand-primary rounded-lg relative  -mt-[125px]">
            <div className="flex items-end">
              ...
              <form className="w-full max-w-[842px]   flex items-end justify-between gap-8">
                <div>
                  ...
                  <input
                    class="shadow border rounded h-[54px] w-[296px] py-2 px-3 text-gray-700 leading-tight focus:outline-brand-primary focus:shadow-outline placeholder:text-base"
                    id="name"
                    type="text"
                ...
                <div className="">
                  <label
                    class="text-base block text-white-700 mb-2"
                    for="email"
                  >
                    E-mail
                  </label>
                  <input
                    class="shadow appearance-none h-[54px] w-[296px] border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-brand-primary  placeholder:text-base"
                    id="email"
                    type="text"
            ...
            <div className="grid grid-rows-4">
              <div className="">
                <p class="width={187} height={83} text-weight-400 text-brand-neutral line-height:0.875rem text-xs  mb-2">
                  Artmazigh studios 160 Robinson Road, #14-04 Singapore Business
