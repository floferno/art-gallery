    ...
    <>
      <div className="bg-brand-senary w-full h-[388px]">
        <Container className={'flex flex-col '}>
          <div className="border text-white py-[63px] px-[34px] w-auto border-brand-primary bg-brand-quaternary rounded-lg relative  -mt-[135px]">
          ...
          <div className="grid grid-cols-12 gap-8 bg-brand-senary mt-[84px]">
            ...
            <Link href={'/contact-us'}>
              <a className="flex col-span-2 text-center justify-center items-center">Contact Us</a>
            </Link>
      ...
      <div className="grid grid-cols-12 max-w-screen-xl text-sm gap-8 w-full px-5 mx-auto relative h-[67px] items-center">
          <p className="col-start-1 col-span-3">Design by: Mindhunter Studios @danyasary</p>
      </div>
    </>
  )
}
